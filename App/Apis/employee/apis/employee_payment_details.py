...
from Apis.employee.schemas import employee_payment_details as schemas
from Apis.employee.services.employee_payment_details import employee_payment_details_service as actions
