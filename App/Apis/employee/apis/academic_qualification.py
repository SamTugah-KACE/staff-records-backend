...
from Apis.employee.schemas import academic_qualification as schemas
from Apis.employee.services.academic_qualification import academic_qualification_service as actions
