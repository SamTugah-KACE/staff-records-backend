...
from Apis.employee.repositories.employment_history import employment_history_actions as employment_history_repo
from Apis.employee.schemas.employment_history import EmploymentHistorySchema, EmploymentHistoryUpdate, EmploymentHistoryCreate
