...
from Apis.employee.repositories.emergency_contact import emergency_contact_actions as emergency_contact_repo
from Apis.employee.schemas.emergency_contact import EmergencyContactSchema, EmergencyContactUpdate, EmergencyContactCreate
