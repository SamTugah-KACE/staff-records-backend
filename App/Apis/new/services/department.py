...
from Apis.new.repositories.department import department_actions as department_repo
from Apis.new.schemas.department import DepartmentSchema, DepartmentUpdate, DepartmentCreate
