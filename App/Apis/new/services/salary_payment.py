...
from Apis.new.repositories.salary_payment import salary_payment_actions as salary_payment_repo
from Apis.new.schemas.salary_payment import SalaryPaymentSchema, SalaryPaymentUpdate, SalaryPaymentCreate
