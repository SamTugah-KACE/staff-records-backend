...
from Apis.new.repositories.next_of_kin import next_of_kin_actions as next_of_kin_repo
from Apis.new.schemas.next_of_kin import NextOfKinSchema, NextOfKinUpdate, NextOfKinCreate
